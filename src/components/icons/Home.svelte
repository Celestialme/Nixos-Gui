<svg on:click={()=>click()} xmlns="http://www.w3.org/2000/svg" width=30 height=30 fill='white' xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 26.39 26.39" xml:space="preserve">
    <g>
        <g id="c14_house">
    ...
    <script>
import { currentScreen, OptionInputValue } from "@src/store/store";
